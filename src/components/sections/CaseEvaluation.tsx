                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 space-y-4">
                    ...
                    <div className="flex items-start space-x-3">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => handleCheckboxChange("agreeToQualification", checked as boolean)}
                        className="mt-1"
                      />
                      <label
                    ...
                    <div className="flex items-start space-x-3">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => handleCheckboxChange("agreeToTermsAndContact", checked as boolean)}
                        className="mt-1"
                      />
                      <label
                    ...
                    <div className="flex items-start space-x-3">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => handleCheckboxChange("agreeToDisclaimer", checked as boolean)}
                        className="mt-1"
                      />
                      <label
